...
## Current State
Full-stack application with PostgreSQL backend, Express API, and React frontend. Version 1.14.2 — Seeker wallet MWA support via @solana-mobile/wallet-adapter-mobile, improved login page with wallet detection badges. Home & Team page UI/UX improvements (v1.14.1). Dynamic Tactic Coefficients (v1.14.0). Per-pitcher pitching staff configs (v1.13.0).
